...
abstract class GoogleshoppingTaxonomy implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\GoogleShopping\\Model\\Map\\GoogleshoppingTaxonomyTableMap';
    ...
    /**
     * Initializes internal state of GoogleShopping\Model\Base\GoogleshoppingTaxonomy object.
     */
    ...
    /**
     * Compares this with another <code>GoogleshoppingTaxonomy</code> instance.  If
     * <code>obj</code> is an instance of <code>GoogleshoppingTaxonomy</code>, delegates to
     * <code>equals(GoogleshoppingTaxonomy)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return GoogleshoppingTaxonomy The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[GoogleshoppingTaxonomyTableMap::ID] = true;
        }
    ...
    public function setTheliaCategoryId($v)
    {
        ...
        if ($this->thelia_category_id !== $v) {
            ...
            $this->modifiedColumns[GoogleshoppingTaxonomyTableMap::THELIA_CATEGORY_ID] = true;
        }
    ...
    public function setGoogleCategory($v)
    {
        ...
        if ($this->google_category !== $v) {
            ...
            $this->modifiedColumns[GoogleshoppingTaxonomyTableMap::GOOGLE_CATEGORY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GoogleshoppingTaxonomyTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GoogleshoppingTaxonomyTableMap::translateFieldName('TheliaCategoryId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGoogleshoppingTaxonomyQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildGoogleshoppingTaxonomyQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GoogleshoppingTaxonomyTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GoogleshoppingTaxonomyTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(GoogleshoppingTaxonomyTableMap::THELIA_CATEGORY_ID)) {
    ...
    {
        $pos = GoogleshoppingTaxonomyTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        $criteria = new Criteria(GoogleshoppingTaxonomyTableMap::DATABASE_NAME);
        $criteria->add(GoogleshoppingTaxonomyTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GoogleShopping\Model\GoogleshoppingTaxonomy (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \GoogleShopping\Model\GoogleshoppingTaxonomy Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCategory(ConnectionInterface $con = null)
    {
        if ($this->aCategory === null && ($this->thelia_category_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCategory->addGoogleshoppingTaxonomies($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(GoogleshoppingTaxonomyTableMap::DEFAULT_STRING_FORMAT);
    }
